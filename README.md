# (Unofficial) eBay API client (PHP) - Developer / Analytics
...
```shell
composer require bricre/ebay-api-developer-analytics
```
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/developer/analytics/v1_beta/',
        'headers'=>[
